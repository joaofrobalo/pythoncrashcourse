...
usernames = ['admin', 'leet', 'h4cker', 'jon', 'snow']
new_users = ['Jon', 'khaleesi', 'tiger', 'leet']

for user in new_users:
    if user.lower() in usernames:
        print(f"{user} is already taken. Have some creativity.")


if usernames:
    for name in usernames:
        if name == 'admin':
            print("Welcome, master. Status reports?")
        else:
            print(f"Welcome, {name} to our humble website.")
else:
    print("We need to find some shmucks!")
